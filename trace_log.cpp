...
#define TRACELOG_MAX_LINE       5120

#define TRACELOG_MAX_FILESIZE   0x6400000    // 100MB
#define TRACELOG_MIN_FILESIZE   5120
	...
	)
{
	...
	// process name
	memset(m_sProcName, 0, PROC_NAME_LENGTH + 1);
	...
	// path
	memset(m_LogFilePath, 0, TRACELOG_MAX_PATH + 1);
